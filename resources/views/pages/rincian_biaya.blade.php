        ...
        <div class="mb-3 px-3 px-md-5 py-4 py-md-5 bg-light shadow-sm">
          <div class="mb-4">
            ...
            <div class="">
              <div class="mb-4">
                <h6># Deskripsi</h6>
                <p class="mb-0">Dalam hal pembiayaan SMA SWASTA KATOLIK MARIANA sangat transparan, semua dijelaskan
              ...
              <div class="mb-4">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th class="font-weight-medium text-center" scope="col">SMA SWASTA KATOLIK MARIANA</th>
              ...
              <div class="mb-4">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th class="font-weight-medium text-center" scope="col" colspan="2">SMA SWASTA KATOLIK MARIANA
                        </th>
                ...
                <p class="mb-0 font-weight-medium">Kesimpulannya Biaya per bulan di SMA SWASTA KATOLIK MARIANA sudah

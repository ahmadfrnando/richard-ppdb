...
<head>
  ...
  <title>PPDB - SMA SWASTA KATOLIK MARIANA</title>
        ...
        <div class="modal-body">
          <div class="d-flex justify-content-center mb-3">
            <div class="d-flex flex-column align-items-center" style="gap: 1rem;">
              <img src="{{ asset('images/foto7.jpeg') }}" alt="" style="max-width: 400px;">
              <h5 class="mb-0 font-weight-medium">Pada tanggal 15 Maret 2023, kami mengadakan workshop tentang teknologi informasi yang dihadiri oleh siswa dan guru. Kegiatan ini bertujuan untuk meningkatkan keterampilan siswa dalam bidang IT.</h5>
            </div>
          </div>
        </div>
        <div class="modal-footer">
